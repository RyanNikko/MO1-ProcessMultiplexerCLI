...
//	std::cout << " " << endl;
//	std::cout << " " << endl;
//	std::cout << "   _____  _____  ____  _____  ______  _______     __" << endl; 
//	std::cout << "  / ____|/ ____|/ __ \\|  __ \\|  ____|/ ____\\ \\   / /" << endl; 
//	std::cout << " | |    | (___ | |  | | |__) | |__  | (___  \\ \\_/ / " << endl; 
//	std::cout << " | |     \\___ \\| |  | |  ___/|  __|  \\___ \\  \\   /  " << endl; 
//	std::cout << " | |____ ____) | |__| | |    | |____ ____) |  | |   " << endl; 
//	std::cout << "  \\_____|_____/ \\____/|_|    |______|_____/   |_|   " << endl; 
//	std::cout << endl;
//	std::cout << "------------------------------------------------" << endl; 
//	std::cout << "Welcome to CSOPESY Emulator!" << endl << endl;
//	std::cout << "Group 2 - Apa, Geralde, Kho, Taino" << endl;
//	std::cout << "Last updated: 07-06-2024" << endl;
//	std::cout << "------------------------------------------------" << endl;
//}
